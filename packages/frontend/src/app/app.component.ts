...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.searchService.getSearchEntity()
      .subscribe(searchEntity => this.sidebarVisible = !!searchEntity);

    this.placeService.getSelectedPlace()
      .subscribe(selectedPlace => this.placeInfoModalVisible = !!selectedPlace);
  }
}
